...
struct PointCorrespondence {
  double t_point;
  double t_map;
  Eigen::Vector3d point;		///< 雷达系下的原始点
  Eigen::Vector3d point_raw;
  GeometryType geo_type;		///< 观测值类型: 点到线/点到面
  Eigen::Vector4d geo_plane;	///< 全局系下的平面方程
  Eigen::Vector3d geo_normal;	///< 直线方向
  Eigen::Vector3d geo_point;	///< 直线上一点
};
